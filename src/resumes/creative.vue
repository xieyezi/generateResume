          ...
          <div class="right-column">
            <div class="experience-section section">
              <div class="icon">
                ...
                <span class="section-headline">工作经历</span>
              </div>
            ...
            <div class="education-section section">
              <div class="icon">
                ...
                <span class="section-headline">教育经历</span>
              </div>
            ...
            <div v-if="person.projects" class="projects-section section">
              <div class="icon">
                ...
                <span class="section-headline">项目经历</span>
              </div>
            ...
            <div v-if="person.skills" class="skills-section section">
              <div class="icon">
                ...
                <span class="section-headline">专业技能</span>
              </div>
            ...
            <div v-if="person.contributions" class="contributions-section section">
              <div class="icon">
                ...
                <span class="section-headline">贡献</span>
              </div>
...
export default {
  ...
  methods: {
    download(){
         //导出PDF
        downloadPDF( document.querySelector('#creative'), this.htmlTitle);
    }
  },
  created() {
  }
